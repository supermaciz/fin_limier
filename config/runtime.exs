...
#
#     PHX_SERVER=true bin/fin_limier start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :fin_limier, FinLimierWeb.Endpoint, server: true
end
...
if config_env() == :prod and System.get_env("JOB_OFFER_STORE", "postgres") != "ets" do
  ...
  config :fin_limier, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :fin_limier, FinLimier.Mailer,
